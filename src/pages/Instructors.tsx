...
const instructors = [
  {
    name: "Domingos",
    role: "Co-Fundador & Instrutor Principal",
    specialties: ["Treino Personalizado", "Musculação", "Kickboxing"],
    bio: "Licenciado em Educação Física com vasta experiência em gestão desportiva e treino personalizado. Dedicado a transformar vidas através do exercício físico estruturado e orientação profissional.",
    image: imgDomingos,
  },
  {
    name: "Baltazar",
    role: "Co-Fundador & Instrutor de Natação",
    specialties: ["Actividades Aquáticas", "Hidroginástica", "Natação Infantil"],
    bio: "Especialista em actividades aquáticas com foco na segurança e desenvolvimento técnico. Da iniciação ao aperfeiçoamento, respeita o ritmo de cada aluno para garantir resultados seguros e eficazes.",
    image: imgBaltazar,
  },
  {
    name: "William",
    role: "Co-Fundador & Instrutor de Grupo",
    specialties: ["Aulas em Grupo", "Aeróbica", "Funcional", "Spinning"],
    bio: "Profissional certificado em Educação Física, especialista em aulas dinâmicas e motivadoras. Foca na saúde, bem-estar e socialização, com metodologias adaptadas a todos os níveis de condição física.",
    image: imgWilliam,
  },
];
