...
CREATE POLICY "hero_insert" ON public.hero_content FOR INSERT WITH CHECK (is_admin());
CREATE POLICY "hero_update" ON public.hero_content FOR UPDATE USING (is_admin()) WITH CHECK (is_admin());
CREATE POLICY "hero_delete" ON public.hero_content FOR DELETE USING (is_admin());
...
CREATE POLICY "services_insert" ON public.services FOR INSERT WITH CHECK (is_admin());
CREATE POLICY "services_update" ON public.services FOR UPDATE USING (is_admin()) WITH CHECK (is_admin());
CREATE POLICY "services_delete" ON public.services FOR DELETE USING (is_admin());
...
CREATE POLICY "pricing_insert" ON public.pricing_plans FOR INSERT WITH CHECK (is_admin());
CREATE POLICY "pricing_update" ON public.pricing_plans FOR UPDATE USING (is_admin()) WITH CHECK (is_admin());
CREATE POLICY "pricing_delete" ON public.pricing_plans FOR DELETE USING (is_admin());
...
CREATE POLICY "instructors_insert" ON public.instructors FOR INSERT WITH CHECK (is_admin());
CREATE POLICY "instructors_update" ON public.instructors FOR UPDATE USING (is_admin()) WITH CHECK (is_admin());
CREATE POLICY "instructors_delete" ON public.instructors FOR DELETE USING (is_admin());
...
CREATE POLICY "gallery_insert" ON public.gallery_images FOR INSERT WITH CHECK (is_admin());
CREATE POLICY "gallery_update" ON public.gallery_images FOR UPDATE USING (is_admin()) WITH CHECK (is_admin());
CREATE POLICY "gallery_delete" ON public.gallery_images FOR DELETE USING (is_admin());
