...
-- Also allow users to check their own roles (needed for auth bootstrap)
...
-- Storage: allow admin uploads to cms-images bucket
...
CREATE POLICY "Public can read cms images" ON storage.objects FOR SELECT USING (bucket_id = 'cms-images');
